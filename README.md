# Measuring Biodiversity Using Machine Learning

## Requirement
The codes tested on Python 3.9.7 (Anaconda).

## Data
The raw data is a csv file including all articles with the topic of biodiversity gathered from Financial Times.
...
## Biodiversity score calculator

1. This procedure follows [GitHub repository.](https://github.com/sasi2400/sustainableentrepreneurship.org)

2. Replace the text in `Biodiversity_Score_Calculator.ipynb` and run the Jupyter Notebook, the Biodiversity Score of the text will be calculated and a word cloud will be drawn.